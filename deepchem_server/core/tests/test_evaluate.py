...
from deepchem_server.core import config, cards, evaluate
...
def test_model_evaluator(disk_datastore):
    ...
    output_address = evaluate.model_evaluator(
...
def test_model_evaluator_error_check(disk_datastore):
    ...
    try:
        evaluate.model_evaluator(dataset_addresses=[dataset_address],
                                 model_address=model_address,
                                 metrics=['prc_auc_curve'],
                                 output_key='model_eval_prc',
