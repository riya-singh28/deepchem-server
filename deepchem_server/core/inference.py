"""This file contains utilities to run inference against datasets with deepchem."""
import os
import csv
import pandas as pd
import pathlib
...
from deepchem_server.core import feat
from deepchem_server.core.cards import DataCard
from deepchem_server.core.progress_logger import log_progress
from typing import Optional, Union, Iterator, Callable, Sequence
...
def _infer_with_featurize(
    ...
    ----------
    model_address: str
        deepchem address of model to run inference for
    data_address: str
        deepchem address of raw data to run inference on
    dataset_column: str
    ...
    if featurizer_code not in feat.featurizer_map:
        raise ValueError("Featurizer not recognized.")
    featurizer = feat.featurizer_map[featurizer_code](**feat_kwargs)
