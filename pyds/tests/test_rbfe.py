...
class TestRelativeBindingFreeEnergy:
    ...
    def test_run_with_all_parameters(self, test_settings: Settings, live_data_client: Data) -> None:
        ...
        solvent = {
            "positive_ion": "Na+",
            "negative_ion": "Cl-",
            "ion_concentration": "0.15 mol/litre",
            "neutralize": True
        }
        rbfe_settings = {
            "simulation_settings": {
                "equilibration_length": "0.1 ps",
                "production_length": "0.1 ps",
                "time_per_iteration": "0.01 ps"
            },
            "integrator_settings": {
                "timestep": "0.01 ps"
            }
        ...
        upload_ligands_sdf_address = live_data_client.upload_data(
            file_path=ASSETS_DIR / "ligands.sdf",
        ...
        upload_cleaned_protein_pdb_address = live_data_client.upload_data(
            file_path=ASSETS_DIR / "181L_mod_capped_protonated.pdb",
